...
fn reserved_words_name_properties_after_a_dot_and_in_a_literal() {
    assert_eq!(
        number("let o = { class: 3, await: 4 }; return o.class + o.await;"),
        7.0
    );
    assert_eq!(
        number("let o = {}; o.class = 5; o.switch = 6; return o.class + o.switch;"),
        11.0
    );
    assert_eq!(
        number("let o = { class: 1 }; return o[\"class\"] + o.class;"),
        2.0
    );
}
