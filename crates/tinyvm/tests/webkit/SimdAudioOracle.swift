    ...
    static func main() throws {
        ...
        let value = context.evaluateScript(
            ...
            (() => {
              ...
              return `${added}|${subtracted}|mask=${any}|rearrange=pass|lanes=pass|comparisons=pass|reductions=pass|bounds=pass|bridge=pass`;
            })()
            """
        )
        if let javascriptError { throw OracleError.javascript(javascriptError) }
        let result = value?.toString() ?? ""
        let expected = "32767,-32768,300,-300,32767,-32768,-5000,5000|20000,-20000,-100,100,32766,-32767,32767,-32768|mask=1,0|rearrange=pass|lanes=pass|comparisons=pass|reductions=pass|bounds=pass|bridge=pass"
