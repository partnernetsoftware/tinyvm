...
echo 'OK: WABT, tinyvm, JavaScriptCore and H5 agree on SIMD audio, masks, byte rearrangement, integer lanes, comparisons, reductions, lane bounds, saturation and scalar bridge'
